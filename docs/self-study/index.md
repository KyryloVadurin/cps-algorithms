...
| Тема 1. Теоретичні засади алгоритмізації |  4 | 10 |
| Тема 2. Керуючі конструкції в алгоритмах реального часу | 4 | 12 |
| Тема 3. Архітектура та обмін даними |  4 | 12 |
| Тема 4. Алгоритми обробки структурованих даних |  4 | 12 |
| **Усього за змістовим модулем 1** |  **16** | **46** |
| **Змістовий модуль 2. Нечітке керування, оптимізаційні алгоритми та віртуалізація** |   |  |
| Тема 5. Нечітка логіка та евристики |  4 | 12 |
| Тема 6. Пошук, сортування та графи в мережах |  6 | 16 |
| Тема 7. Хмарні та граничні обчислення |  4 | 16 |
| **Усього за змістовим модулем 2** |  **14** | **44** |
| Розрахунково-графічна робота |  — | 30 |
| **Всього годин з дисципліни** |  **30** | **120** |
