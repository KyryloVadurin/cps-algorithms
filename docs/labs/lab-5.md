...
### **2.1. Концепція нечіткої логіки в кіберфізичних системах**
...
### **2.2. Лінгвістичні змінні та терми**
...
### **2.3. Алгоритм нечіткого логічного виведення за методом Мамдані**
...
### **2.4. Математичний апарат нечіткого регулятора**
...
### **4.2. Покрокова розробка потоку нечіткого контролера в Node-RED**
...
#### **Крок 5. Повний код експорту конфігураційного потоку Node-RED (Flow JSON)**
...
### **4.3. Тестування та перевірка дашборду**
...
2.  **Завдання варіанта:** Таблиця з вхідними параметрами вашого варіанта (Об'єкт КФС, цільова температура $T_{set}$, параметри функцій приналежності термів, період опитування).
