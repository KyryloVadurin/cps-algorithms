# МЕТОДИЧНА ІНСТРУКЦІЯ ДО ВИКОНАННЯ ЛАБОРАТОРНОЇ РОБОТИ № 1

## **Дисципліна:** Прикладні алгоритми кіберфізичних систем
## **Тема:** Теоретичні засади алгоритмізації в КФС (Формальні моделі обчислень: Машини Поста та Тюрінґа)
## **Лабораторна робота № 1:** Моделювання логіки керування низького рівня

---

## **1. Мета роботи та стек технологій**

**Мета роботи:** Ознайомлення з теоретичними засадами алгоритмізації в кіберфізичних системах (КФС), дослідження фундаментальних властивостей детермінованості, дискретності та покрокового виконання обчислювальних процесів шляхом розробки та програмної реалізації симулятора абстрактної обчислювальної машини Поста мовою JavaScript у середовищі Node.js.

**Стек технологій та інструменти:**
*   **Мова програмування:** JavaScript (ECMAScript 2022+).
*   **Середовище виконання:** Node.js (версія v18.0.0 або новіша).
*   **Інструменти розробки:** Системна консоль/термінал (Bash, PowerShell або zsh), текстовий редактор або інтегроване середовище розробки (Visual Studio Code, WebStorm).

---

## **2. Теоретичні відомості**

### **2.1. Концепція Brainware, Software та Hardware в кіберфізичних системах**
...
### **2.2. Властивості алгоритмів у контексті КФС**
...
### **2.3. Формальна модель обчислень: Машина Поста**
...
### **2.4. Математичний апарат оцінки обчислювальної складності**
...
Кожен студент виконує варіант, який відповідає його номеру у списку групи. Завдання полягає в побудові системи команд машини Поста для обробки унарних сигналів та перевірці її роботи на розробленому емуляторі.
...
### **4.2. Покрокова розробка емулятора машини Поста**
...
### **4.3. Алгоритм роботи програмного емулятора**
...
sequenceDiagram
    autonumber
    actor Student as Студент / Розробник
...
### **4.4. Запуск та перевірка виконання**
...
1.  **Титульна сторінка:**
    ...
    *   ПІБ студента, шифр навчальної групи, ПІБ викладача.
2.  **Мета роботи та короткі теоретичні відомості:**
    *   Виклад основного теоретичного базису (концепція Brainware, 6 команд Поста, правило колізій, унарне кодування).
...
## **6. Контрольні запитання для захисту роботи**
