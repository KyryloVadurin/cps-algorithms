# **Лабораторна робота № 6<br>Оптимізація маршрутів у сенсорних мережах**
...
### Топологія сенсорних мереж КФС як зважений граф
...
### Математична логіка алгоритму Дейкстри та атрибути вершин
...
### Застосування пріоритетної черги на основі двійкової мінімальної купи
...
### Покроковий алгоритм розробки скетчу C++
...
### Схема апаратно-програмної взаємодії в SimulIDE
