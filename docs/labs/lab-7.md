...
### Контейнеризація проти апаратної віртуалізації на граничному рівні КФС
...
### Декларативне оркестрування за допомогою Docker Compose
...
### Математичний апарат оцінки ресурсів віртуалізованого стека
...
### Покроковий алгоритм розробки конфігураційних файлів
...
### Команди розгортання та керування контейнерами

Виконайте наступні CLI-команди у системному терміналі з папки проєкту `cps-lab7-docker`:

#### Запуск мікросервісного стека у фоновому режимі
```bash
docker compose up -d
```
...
### Налаштування збору телеметрії та перевірка енергонезалежності даних
...
#### Перевірка енергонезалежності даних
...
4.  **Результати виконання команд у терміналі.**
