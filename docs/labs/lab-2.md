...
# МЕТОДИЧНА ІНСТРУКЦІЯ ДО ВИКОНАННЯ ЛАБОРАТОРНОЇ РОБОТИ № 2

## **Дисципліна:** Прикладні алгоритми кіберфізичних систем
## **Тема:** Керуючі конструкції в алгоритмах реального часу (Розгалуження та цикли)
## **Лабораторна робота № 2:** Розробка алгоритмів обробки даних з давачів

---

## **1. Мета роботи та стек технологій**

**Мета роботи:** Набуття практичних навичок проєктування та реалізації високоефективних алгоритмів первинної обробки телеметрії від сенсорних пристроїв у системах жорсткого реального часу. Навчання включає реалізацію алгоритмів відсікання аномальних значень і шуму за допомогою умовних розгалужень та обчислення ковзного середнього з використанням циклічних конструкцій мовою C/C++ у середовищі Arduino IDE та схемотехнічному симуляторі SimulIDE.
...
### **2.1. Особливості алгоритмів обробки телеметрії в системах жорсткого реального часу**
...
### **2.2. Стратегія побудови умовних розгалужень без складних булевих виразів**
...
### **2.3. Циклічні конструкції та накопичення ковзного середнього**
...
### **2.4. Математичний апарат та функції трудомісткості**
...
### **4.2. Покроковий алгоритм розробки скетчу в Arduino IDE**
...
### **4.3. Компіляція та завантаження прошивки в SimulIDE**
...
### **4.4. Проведення експерименту та зняття логів**
...
2.  **Мета роботи та варіант завдання:** Сформульована мета, а також таблиця з вхідними параметрами обраного варіанта ($V_{ref}$, $T_{min}$, $T_{max}$, $T_{low}$, $T_{high}$, $N$).
