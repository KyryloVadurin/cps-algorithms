...
**Тема:** Алгоритми пошуку та сортування у КФС  
...
2.  **Завдання варіанта:** Таблиця з вхідними параметрами вашого варіанта (Джерело телеметрії, порядок даних, напрямок сортування, вибір півота QuickSort).
...
4.  У чому полягає перевага алгоритму сортування вставками (Insertion Sort) при обробці частково впорядкованих масивів сигналів КФС?
