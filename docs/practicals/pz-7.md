## Практичне заняття № 7. Аналіз архітектурних рішень для Big Data

**Тема:** Big Data в КФС та Lambda-архітектура  
...
2.  **Завдання варіанта:** Таблиця з вхідними параметрами вашого варіанта (Назва КФС, вхідні параметри, шаблон CEP-правила, тривалість вікна $\Delta t$, обсяг $D_{master}$).
