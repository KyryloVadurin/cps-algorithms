## Практичне заняття № 4. Реалізація черги повідомлень для керування завданнями

**Тема:** Лінійні структури даних (Стек, черга, пріоритетна черга)  
...
2.  **Завдання варіанта:** Таблиця з вхідними параметрами вашого варіанта (Джерело телеметрії, дисципліна FIFO/LIFO, ємність $N$, стратегія переповнення Drop/Overwrite, інтенсивності $P_{peak}$ та $P_{proc}$).
